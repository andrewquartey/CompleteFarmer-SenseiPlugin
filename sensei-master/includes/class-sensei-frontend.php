	...
	public function sensei_login_form() {
		...
		<div id="my-courses">
			...
			if ( get_option('users_can_register') ) {
				...
				<div class="col-2">
					<h2>Create Your CompleteFarmer Account</h2>
				<div class="form-description">Your user account is your portal to all the CompleteFarmer dashboard: your classroom, farm management, forums and more!</div>
					...
					<form method="post" class="register"  action="<?php echo esc_url( $action_url ); ?>" >
						...
						<p class="form-row form-row-wide">
							<input type="text" placeholder="Username" class="input-text" name="sensei_reg_username" id="sensei_reg_username" value="<?php if ( ! empty( $_POST['sensei_reg_username'] ) ) echo esc_attr( $_POST['sensei_reg_username'] ); ?>" />
						</p>

						<p class="form-row form-row-wide">
							<input type="email" placeholder="Email Address" class="input-text" name="sensei_reg_email" id="sensei_reg_email" value="<?php if ( ! empty( $_POST['sensei_reg_email'] ) ) echo esc_attr( $_POST['sensei_reg_email'] ); ?>" />
						</p>

						<p class="form-row form-row-wide">

							<input type="password" placeholder="Password" class="input-text" name="sensei_reg_password" id="sensei_reg_password" value="<?php if ( ! empty( $_POST['sensei_reg_password'] ) ) echo esc_attr( $_POST['sensei_reg_password'] ); ?>" />
						</p>
